...
Initializes a transfer request for the specified server and returns immediately. The transfer process runs in the background. In summary, the process goes as follows:
...
| 409  | A transfer is already in progress for this server.      |

Sources:

- [router/router_server_transfer.go#L27](https://github.com/pastanetwork/wings/blob/develop/router/router_server_transfer.go#L27)
...
- [router/router_server_transfer.go#L109](https://github.com/pastanetwork/wings/blob/develop/router/router_server_transfer.go#L109)
